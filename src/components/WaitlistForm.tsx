            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 bg-white/5 border border-white/10 p-4 rounded-2xl">
                    {WAITLIST_OPTIONS.map(opt => {
                      ...
                      return (
                        ...
                        >
                          <span className={`w-2 h-2 rounded-full shrink-0 ${opt.bgColor}`} />
                          <span className="truncate">{opt.name}</span>
                          {isChecked && <Check className="w-3 h-3 stroke-[3px] text-blue-300 ml-auto shrink-0" />}
                        </button>
                      );
                    })}
                  </div>
