...
export default function WaitlistForm() {
  ...
  return (
    <div id="waitlist" className="w-full bg-white/95 backdrop-blur-sm border border-white/20 rounded-3xl overflow-hidden shadow-xl shadow-black/10 relative max-w-4xl mx-auto">
